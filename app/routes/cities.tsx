...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "City-wise breakdown of builders and projects shipped across India in the GrowthX community." },
  { property: "og:title", content: "Cities — Built at GrowthX" },
  { property: "og:description", content: "City-wise breakdown of builders and projects shipped across India in the GrowthX community." },
  { property: "og:type", content: "website" },
  { name: "twitter:card", content: "summary" },
  { name: "twitter:title", content: "Cities — Built at GrowthX" },
  { name: "twitter:description", content: "City-wise breakdown of builders and projects shipped across India in the GrowthX community." },
  { tagName: "link", rel: "canonical", href: "https://built.growthx.club/cities" },
];
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "var(--sans)" }}>
      ...
      <main className="responsive-main" style={{ maxWidth: 960, margin: "0 auto", padding: "32px 32px 100px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {cities.map((city, i) => (
            <div key={city.name} className={`fade-up stagger-${Math.min(i + 1, 6)} list-item-hover`} style={{
              padding: "18px 24px", background: C.surface,
              border: `1px solid ${C.border}`, borderRadius: 14,
              marginBottom: 6,
