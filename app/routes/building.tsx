...
export const meta: MetaFunction = () => [
  { title: "Currently Building — Built at GrowthX" },
  { name: "description", content: "Projects currently in progress by GrowthX members — ideas, prototypes, and betas being built right now." },
  { property: "og:title", content: "Currently Building — Built at GrowthX" },
  { property: "og:description", content: "Projects currently in progress by GrowthX members — ideas, prototypes, and betas being built right now." },
  { property: "og:type", content: "website" },
  { name: "twitter:card", content: "summary" },
  { name: "twitter:title", content: "Currently Building — Built at GrowthX" },
  { name: "twitter:description", content: "Projects currently in progress by GrowthX members — ideas, prototypes, and betas being built right now." },
  { tagName: "link", rel: "canonical", href: "https://built.growthx.club/building" },
];
        ...
        <div style={{
          ...
          {isMobile ? (
            <>
              ...
              <BuiltLogo height={36} onClick={() => navigate("/")} />
                  ...
                  <div ref={profileMenuRef} style={{ position: "relative" }}>
                    ...
                    {showProfileMenu && (
                      <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, background: C.surface, border: `1px solid ${C.border}`, borderRadius: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.1)", minWidth: 180, overflow: "hidden", zIndex: 100 }}>
                        <button onClick={() => { setShowProfileMenu(false); navigate("/my-projects"); }} style={{ width: "100%", padding: "12px 16px", border: "none", background: "none", cursor: "pointer", fontSize: T.bodySm, fontWeight: 500, color: C.text, fontFamily: "var(--sans)", textAlign: "left", display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", gap: isTablet ? 24 : 40 }}>
                <BuiltLogo height={40} onClick={() => navigate("/")} />
                  ...
                  <div ref={profileMenuRef} style={{ position: "relative" }}>
                    ...
                    {showProfileMenu && (
                      <div style={{
                        ...
                        <button onClick={() => { setShowProfileMenu(false); navigate("/my-projects"); }} style={{
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ padding: "16px 12px", display: "flex", flexDirection: "column", gap: 2, flex: 1 }}>
              {NAV_TABS.map(t => (
                <button key={t.href} onClick={() => { setMobileMenuOpen(false); navigate(t.href); }} style={{
              ...
              <button onClick={() => { setMobileMenuOpen(false); navigate("/"); }} style={{
